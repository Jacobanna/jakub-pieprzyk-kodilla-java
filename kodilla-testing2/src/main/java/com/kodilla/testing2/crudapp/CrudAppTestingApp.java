...
public class CrudAppTestingApp {
    ...
    //XPATH RELATIVE
    public static final String XPATH_SELECT = "//div[contains(@class, \"tasks-container\")]/form[1]/div/fieldset/select[1]";

    public static void main(String[] args) {
        WebDriver driver = WebDriverConfig.getDriver(WebDriverConfig.CHROME);
        driver.get("https://jacobanna.github.io/");
        ...
        textareaField2.sendKeys("Robotic task description");
        //XPATH POSITION
